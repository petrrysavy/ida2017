...
public class SequenceTest {
    ...
    public void testFromString() {
        ...
        assertThat(Sequence.fromString("AT"), is(equalTo(new Sequence(new char[]{'A', 'T'}, null))));
        assertThat(Sequence.fromString("ATC"), is(equalTo(new Sequence(new char[]{'A', 'T', 'C'}, null))));
        assertThat(Sequence.fromString("ATCG"), is(equalTo(new Sequence(new char[]{'A', 'T', 'C', 'G'}, null))));
    }
